...
//        }
        ...
        nav_view.getHeaderView(0).findViewById<TextView>(R.id.nav_head_name_tv).text = "欢迎您！${MyApplication.user.nickname}"
...
//                        Log.e("TAG","====${cal.timeInMillis-time}====")
            ...
            R.id.nav_share -> {
                ...
                textIntent.putExtra(Intent.EXTRA_TEXT, "谢谢大家，这是测试软件分享");
