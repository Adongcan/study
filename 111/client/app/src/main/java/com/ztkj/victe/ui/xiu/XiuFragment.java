...
public class XiuFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (MyApplication.user.getUserLevel()==2){
    ...
    private void getData(){
        ...
        String method="getAllXiu";
        if (MyApplication.user.getUserLevel()==2){
            method="getAllXiuByDoctor";

        }
        RetrofitTools.Companion.post(method,map, Xiu.class,new RetrofitTools.IRetrofitResponse() {
