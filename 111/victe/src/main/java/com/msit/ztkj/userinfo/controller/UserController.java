...
public class UserController {
    ...
    @ResponseBody
    @RequestMapping("/getAllUsersByuserno")
    public List<User> getAllUsersByuserno(User user){
        return userMapper.getAllUsersByuserno(user);
    }

    @ResponseBody
    @RequestMapping("/getAllUsersByUserId")
    public List<User> getAllUsersByUserId(User user){
        return userMapper.getAllUsersByUserId(user);
    }
